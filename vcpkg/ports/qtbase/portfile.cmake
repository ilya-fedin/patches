...
if (QT_VERSION VERSION_EQUAL VERSION)
    file(GLOB ${PORT}_PATCHES ${CMAKE_CURRENT_LIST_DIR}/../../../${PORT}_${QT_VERSION}/*)
    ...
    file(GLOB ${PORT}_PATCHES
        ${CMAKE_CURRENT_LIST_DIR}/../../../${PORT}_${QT_VERSION}/*
        ${CMAKE_CURRENT_LIST_DIR}/${QT_VERSION}/*
    )
endif()
...
foreach(_input IN LISTS input_vars)
    ...
    if("${_input}" IN_LIST FEATURES)
        if(_input STREQUAL "harfbuzz" AND VCPKG_TARGET_IS_LINUX)
            string(APPEND INPUT_OPTIONS qt)
        else()
...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_GUI_OPTIONS
    ...
    "lcms"                CMAKE_DISABLE_FIND_PACKAGE_LCMS2
...
if(VCPKG_TARGET_IS_LINUX)
    list(APPEND FEATURE_GUI_OPTIONS -DQT_QPA_PLATFORMS="wayland\\\\\\;xcb")
endif()
...
qt_install_submodule(PATCHES    ${${PORT}_PATCHES}
                     ...
                     CONFIGURE_OPTIONS
                        ...
                        -DQT_USE_BUNDLED_BundledHarfbuzz:BOOL=${VCPKG_TARGET_IS_LINUX}
                        -DQT_USE_BUNDLED_BundledLibpng:BOOL=FALSE
                        -DQT_USE_BUNDLED_BundledPcre2:BOOL=FALSE
                        -DINPUT_bundled_xcb_xinput:STRING=yes
