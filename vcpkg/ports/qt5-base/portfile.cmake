...
file(GLOB PATCHES ${CMAKE_CURRENT_LIST_DIR}/../../../qtbase_${VERSION}/*)
...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    list(APPEND CORE_OPTIONS -no-feature-netlistmgr)
    if("angle" IN_LIST FEATURES)
        list(APPEND 
                -opengl es2
                -DDESKTOP_APP_QT_STATIC_ANGLE
                QMAKE_LIBS_OPENGL_ES2_DEBUG=-llibGLESv2
                QMAKE_LIBS_OPENGL_ES2_RELEASE=-llibGLESv2
                QMAKE_LIBS_EGL_DEBUG=-llibEGL
                QMAKE_LIBS_EGL_RELEASE=-llibEGL
            )
        if(${VCPKG_LIBRARY_LINKAGE} STREQUAL "static")
            list(APPEND CORE_OPTIONS -DKHRONOS_STATIC)
            list(APPEND RELEASE_OPTIONS
                "QMAKE_LIBS_PRIVATE+=-ldxguid -ldxgi -ld3d9 -lANGLE -lzlib"
                )
            list(APPEND DEBUG_OPTIONS
                "QMAKE_LIBS_PRIVATE+=-ldxguid -ldxgi -ld3d9 -lANGLE -lzlibd"
                )
        endif()
    else()
